#!/usr/bin/env node
// scripts/check-goal-106.mjs — 자동 생성 (vhk goal sync).
...
if (existsSync('.vhk/HARD_STOP')) {
  console.log('🛑 .vhk/HARD_STOP detected — refusing to run goal 106 gate.')
  process.exit(1)
}
...
let pass = true
const gate = (label, ok) => { console.log('[goal 106] ' + label + ': ' + (ok ? '✓' : '✗')); if (!ok) pass = false }
...
if (pass) { console.log('✅ goal 106 gate passes'); process.exit(0) }
console.log('❌ goal 106 gate failed'); process.exit(1)
