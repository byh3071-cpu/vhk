...
- `PRIVATE_RULES_ROOT`, `rulesRoot`, `set-rules-root`는 `2.12`에서 제거 예정 경고와 함께 호환하며 `3.0`에서 제거하도록 명시.
...
[Unreleased]: https://github.com/byh3071-cpu/vhk/compare/v2.3.0...HEAD
