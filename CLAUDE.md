...
## 현재 상태
- **버전:** v2.15.0 출시 후보 — 코드·패키지 준비 완료, npm latest는 2.14.0
- **Phase:** **관찰 게이트 진행 중 — 유효 실행 7/10, 관측 15/28일**. 124·125a·137·138 완료(실행 기능은 기본 off). 125b(집행)는 126과 함께. `enforce` 활성화·2.15.0 발행은 게이트 통과 후
- **블로커:** 없음
- **다음 액션:** 유효 실행 3회와 관측 13일을 더 채운 뒤 사람이 계속 여부를 결정하고, 승인 시 CHANGELOG 날짜 확정 → tag → npm publish(2FA). 정의 원본은 [docs/roadmap/2.x-roadmap.md](docs/roadmap/2.x-roadmap.md)
- **마지막 업데이트:** 2026-08-28
