...
## 현재 상태
- **버전:** v2.15.0 출시 후보 — 발행 승인 완료, npm 인증 대기. npm latest는 2.14.0
- **Phase:** **집행 활성화 관찰 게이트 진행 중 — 유효 실행 7/10, 관측 15/28일**. 124·125a·137·138 완료. 오너 결정으로 기본-off 판정 기능의 2.15.0 공개를 승인했으며, `enforce` 활성화와 125b·126은 게이트 통과 후
- **블로커:** npm 인증 없음 — 2.15.0 발행만 차단, 코드·검증 완료
- **다음 액션:** npm 로그인 후 2.15.0 발행·태그를 완료한다. 별도로 유효 실행 3회와 관측 13일을 더 채운 뒤 사람이 자동 집행 활성화와 2.16 진행 여부를 결정한다. 정의 원본은 [docs/roadmap/2.x-roadmap.md](docs/roadmap/2.x-roadmap.md)
- **마지막 업데이트:** 2026-08-28
