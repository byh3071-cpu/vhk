...
- **다음 할 일:** measure-first — diff-cover 5건 측정 끝(승격 보류). **남은 건 `vhk recall` 실사용→eval(RFC 0049 §5)** 후 2종 종합 PR2/2차ML 결정. 병행: 미완 goal(린트 25/27·#128, SEO 21~26). 열린 이슈 = 0개(#38 포함 전부 closed, 2026-06-10 확인).
