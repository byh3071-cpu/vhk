# [박제] 구 roadmap.md — v1.4.0 시절 스프린트 보드 (2026-05-30 작성분)

> 2026-07-13 로드맵 재편(docs/log/2026-07-13-roadmap-realign-p1.md)으로
> `docs/state/roadmap.md`를 "분기층 로드맵"으로 재작성하면서, 기존 내용을 여기 원문 그대로 박제한다.
> ⚠️ 아래 §4(goal 엣지케이스 ①②③)·§6(R2 MED ⑦⑧⑨)의 Deferred 항목은 완료 여부 미검증 —
> 백로그 재평가 시 이 문서를 소스로 쓸 것.
